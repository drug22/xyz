<div>
    <flux:heading size="xl">Create New Package</flux:heading>
    <flux:text class="mt-2">Add a new pricing package with multi-currency support</flux:text>
