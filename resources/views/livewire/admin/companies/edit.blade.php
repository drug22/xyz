<div>
    ...
    <flux:text class="mt-2">Update {{ $company->name }} information and subscription details</flux:text>
    ...
    <form wire:submit="update" class="mt-6 space-y-6">
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-2">
                        @if($company->is_trial)
                            <flux:badge color="orange" icon="clock">Trial Account</flux:badge>
                        @endif
                        @if($company->vat_payer)
                            <flux:badge color="green" icon="check">VAT Payer</flux:badge>
                        @endif
                    </div>
                </div>
                ...
                <div class="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <flux:text size="sm" class="text-blue-700 dark:text-blue-300">
                        <strong>Users:</strong> {{ $company->users_count }} •
        ...
        <div class="flex justify-between">
            <flux:button :href="route('admin.companies.index')" wire:navigate variant="danger">
                Cancel
            </flux:button>
